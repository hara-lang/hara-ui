...
export function createSpecExplorer(root, { manifestUrl = "spec-manifest.json", fileUrl = (path) => path, repositoryUrl, titlePrefix } = {}) {
  ...
  if (titlePrefix) {
    elements.crumb.textContent = titlePrefix;
